SELECT
	...
	WHERE cxcm.bulk_customer_id = '1000002954'
		...
		select * from mis_db.ext_mdm_office_master where office_id='21661058'
		select * from mis_db.new_customer_xml_facility_customer_mv AS cxcm where cxcm.article_number='AW777317244IN'
		select * from mis_db.new_customer_tracking_event_mv where article_number='AW777317244IN'
		----
		 		SELECT
