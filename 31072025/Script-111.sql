...
WHERE nctem.article_number IN (
    ...
    WHERE event_date > parseDateTime64BestEffort('2025-07-26 00:24:53.952')
      AND event_date <= parseDateTime64BestEffort('2025-07-26 09:24:53.952')
      
    ORDER BY event_date DESC
    LIMIT 1000
)
AND nctem.booking_date > parseDateTime64BestEffort('2025-07-26 00:24:53.952')
AND nctem.booking_date <= parseDateTime64BestEffort('2025-07-26 09:24:53.952')
LIMIT 1000;

-------------
select * from mis_db.new_customer_tracking_event_mv nctem 
select * from mis_db.new_customer_xml_facility_customer_mv nctem 
...
WHERE
    cxcm.bulk_customer_id = 3000042033
    AND cxcm.booking_date > parseDateTime64BestEffort('2025-07-01 00:24:53.952')
    AND cxcm.booking_date <= parseDateTime64BestEffort('2025-07-26 09:24:53.952')
    AND te.event_date > parseDateTime64BestEffort('2025-07-01 00:24:53.952')
    AND te.event_date <= parseDateTime64BestEffort('2025-07-26 09:24:53.952')