...
WHERE article_number IS NOT NULL ;--AND event_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)

select * from mis_db.ext_pdmanagement_article_transaction AS epat where epat.booking_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)
select * from mis_db.mv_new_article_events_tracking_event AS epat where epat.event_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)

select * from mis_db.mv_new_bag_events_tracking_event AS epat where epat.event_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)


select * from mis_db.mv_new_customer_xml_facility_customer_mv AS epat where epat.booking_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)
...
AND parseDateTimeBestEffort(cxcm.booking_date) BETWEEN toDateTime64('2025-07-01 00:01:57.198516', 6) AND toDateTime64('2025-07-13 23:59:57.198516', 6)
AND te.event_date BETWEEN toDateTime64('2025-07-07 00:01:57.198516', 6) AND toDateTime64('2025-07-07 23:59:57.198516', 6)
...
select * from mis_db.ext_mailbkg_booking_address AS kba1 where  address_id='851079207346208'
select * from mis_db.ext_mailbkg_charges_detail AS kcd
--------------------
...
select * from mis_db.customer_log order by generation_time desc limit 1
