---step1
SYSTEM STOP MERGES mis_db.new_customer_tracking_event_mv;
DETACH TABLE mis_db.mv_new_article_events_tracking_event SYNC;
ATTACH TABLE mis_db.mv_new_article_events_tracking_event;
SYSTEM START MERGES mis_db.new_customer_tracking_event_mv;
...
SELECT 
    ...
    zookeeper_exception
FROM system.tables 
WHERE name = 'new_customer_tracking_event_mv';
...
WHERE query LIKE '%ext_pdmanagement_article_transaction%'
ORDER BY elapsed DESC;

-- Kill both long-running count queries
KILL QUERY WHERE query_id = '2705a4fc-5674-40b2-a6ec-df4a1434370c' SYNC;
KILL QUERY WHERE query_id = '915a399b-398e-414f-bafe-c0bd7180bd8b' SYNC;
...
WHERE table = 'ext_pdmanagement_article_transaction';
