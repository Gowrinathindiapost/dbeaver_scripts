...
---------------------22
-- mis_db.amazon_target_table_dt_ib definition

rename TABLE mis_db.amazon_target_table_dt_ib to mis_db.amazon_target_table_dt_ib_bkup_1708 ON CLUSTER cluster_1S_2R;

CREATE TABLE mis_db.amazon_target_table_dt_ib
(
...
rename TABLE mis_db.amazon_target_table_dt to mis_db.amazon_target_table_dt_bkup_1708 ON CLUSTER cluster_1S_2R;

CREATE TABLE mis_db.amazon_target_table_dt
(
...
drop TABLE mis_db.booking_dom_mv ON CLUSTER cluster_1S_2R;
drop TABLE mis_db.booking_intl_mv ON CLUSTER cluster_1S_2R;

rename TABLE mis_db.new_customer_tracking_event_mv to mis_db.new_customer_tracking_event_mv_bkup_1708 ON CLUSTER cluster_1S_2R;
...
SETTINGS index_granularity = 8192;
-------------------19
-- mis_db.new_customer_tracking_event_new_mv definition

rename TABLE mis_db.new_customer_tracking_event_new_mv to mis_db.new_customer_tracking_event_new_mv_bkup_1708 ON CLUSTER cluster_1S_2R;

CREATE TABLE mis_db.new_customer_tracking_event_new_mv
(
...
rename TABLE mis_db.new_customer_xml_facility_customer_mv to mis_db.new_customer_xml_facility_customer_mv_bkup_1708 ON CLUSTER cluster_1S_2R;
...
CREATE TABLE mis_db.new_customer_xml_facility_customer_new_mv
(
...
drop TABLE mis_db.mv_new_booking_dom_to_tracking_event_new ON CLUSTER cluster_1S_2R;
