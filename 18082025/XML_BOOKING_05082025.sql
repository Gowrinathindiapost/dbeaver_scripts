...
FROM (
    ...
    WHERE cxcm.bulk_customer_id = 3000063972 --2000014100 --2000008005 --2000014074 --3000063972 --1000002954
      AND cxcm.booking_date >= toDateTime64('2025-08-17 00:00:00.000000', 6)
      AND cxcm.booking_date <= toDateTime64('2025-08-17 23:59:59.000000', 6)
