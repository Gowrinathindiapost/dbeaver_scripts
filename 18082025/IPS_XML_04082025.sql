CREATE MATERIALIZED VIEW mis_db.mv_new_intl_customer_xml_facility_intl_customer_mv_new TO mis_db.new_intl_customer_xml_facility_intl_customer_new_mv
(
...
SELECT DISTINCT
    ...
    --kba2.zip_code AS destination_pincode,
